	...
	return (
		<section className="container mx-auto flex justify-center pt-12">
			<section className="col-span-3 flex w-full max-w-xl flex-col gap-1 break-words rounded-lg border-2 border-pink-300 bg-pink-50 p-2">
				...
				<div className="text-xs text-pink-400" data-testid="address-hash">
					{payload.hash}
				</div>

				<div className="my-2">
					<span className="rounded-md border-2 border-pink-200 bg-white p-1" data-testid="address-balance">
